...
- (void) applicationWillResignActive: (NSNotification *)notification
{
    ...
    KxDDLogVerbose(@"applicationWillResignActive");
}
...
- (CGFloat) tickCorrection
{
    ...
    //    KxDDLogVerbose(@"tick correction %.4f", correction);
